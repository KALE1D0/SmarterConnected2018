...
/*-----角度环和速度环PID控制参数-----*/
float  g_fCarAngle_P = 20;//10.0  14	 //调大小时会左右摆，调大时会振动  请调到基本能够站立
float  g_fCarAngle_D = 0.011;	// 0.008  0.011	 调小时反应慢，调大时会干扰
float  g_fCarSpeed_P = 5;// 10.2  4.0	4	  5 -10		 //调小一点稳定
float  g_fCarSpeed_I = 0.1;//0.1  0.018  0.01		0.0025- 0.015  -0.1	 电压低时调小，调大，蓝牙控制不稳，会倒
/******蓝牙控制参数******/
